          ...
          const w = {
            ...
            E = e => {
              const t = e.displayMode,
                ...
                a = (0, f.useMemo)((() => t && "modal" !== t ? "integrated" === t || "widget" === t ? "flex flex-col h-full w-full overflow-auto text-black relative webkit-scrollbar" : void 0 : `flex flex-col h-screen w-screen max-h-[90vh] md:max-h-[600px] max-w-[360px] overflow-auto text-black relative bg-jupiter-bg rounded-lg webkit-scrollbar ${r||""}`), [t]);
              return (0, u.jsxs)("div", {
                className: o,
